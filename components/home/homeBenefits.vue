    ...
    <div class="bg-[#D9D9D9] h-fit md:pb-[200px] pt-2">
        <div class="pt-20 pb-10 flex justify-center md:justify-start">
            <div class="md:w-[1000px] md:px-[200px] w-[300px]">
                <div
                    class="md:text-[32px] text-[16px] leading-[150%] font-[600] text-[#000000] text-center md:text-left">
                    What is the
                    benefits of</div>
                ...
                <div
                    ...
                    <div class="md:w-[350px] w-[220px]">
                        <div class="flex gap-7 items-center">
                            <div class="">
                                <nuxt-img src="price.svg" class="md:h-[100px] md:w-[91px] h-[70px] w-[70px]" />
                            </div>
                            <div class="">
                                <p
                ...
                <div
                    ...
                    <div class="md:w-[350px] md:h-fit w-[220px] h-auto">
                        <div class="flex">
                            <div class="flex gap-6 items-center">
                                <div class="">
                                    <NuxtImg src="/Hand.png" class="md:h-[100px] md:w-[100px] h-[70px] w-[70px]" />
                                </div>
                                <div class="">
                                    <p
                                        class="uppercase md:text-[25px] md:font-[900] font-[800] text-[#8D7662] text-[16px]">
