                ...
                <div class="block lg:flex lg:gap-[100px]">
                    <div class="lg:w-[50%]">
                        ...
                        <div
                            ...
                            <NuxtImg src="/contact/contact1.jpg" class="md:rounded-[8px] lg:h-[325px] lg:w-[235px] w-[182px] h-[252px] md:w-full md:h-full object-cover"
                                alt="Contact Image 1" />
                            <NuxtImg src="/contact/contact2.jpg" class="md:rounded-[8px] lg:h-[325px] lg:w-[235px] w-[182px] h-[252px]  md:w-full md:h-full  object-cover"
                                alt="Contact Image 2" />
                        </div>
                    </div>
