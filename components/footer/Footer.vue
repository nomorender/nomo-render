<template>
    <div class="bg-[#FAF8F5] px-20 py-20">
        <div class="flex">
            <NuxtImg src="/logo.png" class="w-[180x] h-[140px]"></NuxtImg>
            <div class="flex flex-col items-start text-left justify-center ml-5">
                <div class="text-[32px] font-[600] text-center">
                    Nomadic Creativity, Timeless Render
                </div>
                <div class="text-[25px] font-thin italic text-center">
        ...
        <div class="mt-20">
            <div class="flex gap-40">
                <div class="w-[455px]">
                    <div class="text-[#8D7662] font-[600] text-[25px] ">Location</div>
                    <p class="text-[25px] font-thin">US, New York NY 10016, 347 5th Ave Suite 1402-374Portugal, Lisbon,
                        Cidade de cardiff 1, 5D</p>
                </div>
                <div class="w-[455px]">
                    <div class="text-[#8D7662] font-[600] text-[25px] ">Contact</div>
                    <p class="text-[25px] font-thin">Email: team@nomorender.com</p>
                    <p class="text-[25px] font-thin">WhatsApp: +84866943407</p>
                </div>
                <div class="w-[455px]">
                    <div class="text-[#8D7662] font-[600] text-[25px] ">Social</div>
                    <div class="mt-3 w-[300px]">
                        <div class="grid grid-cols-4 gap-4">
                            ...
                            <svg viewBox="0 0 32 32" fill="none" height="50px" width="50px"
                            ...
                            <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" height="50px" width="50px"
                            ...
                            <svg height="50px" width="50px" fill="#00b77a" viewBox="0 0 24 24" role="img"
                            ...
                            <svg height="50px" width="50px" viewBox="0 0 32 32" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                            ...
                            <svg height="50px" width="50px" viewBox="0 0 48 48" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
            ...
            <div class="flex mt-20 gap-40">
                <div class="w-[455px]">
                    <div class="text-[#8D7662] font-[600] text-[25px]">3D Rendering Services</div>
                    <div>
                        <div class="text-[#000000] font-thin text-[25px]">3D Exterior Rendering</div>
                        <div class="text-[#000000] font-thin text-[25px]">3D Interior Rendering</div>
                        <div class="text-[#000000] font-thin text-[25px]">3D Furniture Modeling Rendering</div>
                    </div>
                </div>
                <div class="w-[455px]">
                    <div class="text-[#8D7662] font-[600] text-[25px]">Our work</div>
                    <div>
                        <div class="text-[#000000] font-thin text-[25px]">Portfolio</div>
                        <div class="text-[#000000] font-thin text-[25px]">Workflow</div>
                    </div>
                </div>
                <div class="w-[455px]">
                    <div class="text-[#8D7662] font-[600] text-[25px]">Explore</div>
                    <div>
                        <div class="text-[#000000] font-thin text-[25px]">Inspire Space</div>
                        <div class="text-[#000000] font-thin text-[25px]">Library</div>
                    </div>
                </div>
            </div>
        </div>
