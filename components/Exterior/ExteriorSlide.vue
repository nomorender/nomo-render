    ...
    <div class="relative h-fit w-full pb-[50px] pt-[55px] bg-[#FAF8F5]">
      ...
      <div class="md:flex block gap-8 items-center justify-center">
        <div class="relative w-full h-[420px] flex justify-center items-center">
          <div v-for="(slide, index) in slides" :key="index"
            class="absolute w-[calc(80vw)] max-w-[1200px] rounded-[8px] h-full shadow-[0_4px_4px_rgba(0,0,0,0.25)] transition-all duration-300 ease-in-out"
            :class="[
            ...
            <div class="flex justify-center items-center h-full bg-white rounded-[8px]">
              <div class="w-1/2 px-[calc(2vw+1rem)] py-[calc(3vw+1.5rem)] sm:px-[50px] sm:py-[60px]">
                <div class="text-[calc(1.5rem+1vw)] sm:text-[32px] font-semibold text-[#8D7662]">{{ slide.name }}</div>
                <div class="text-[calc(1rem+0.5vw)] sm:text-[25px] font-light text-justify mt-6 sm:mt-10">{{ slide.desc
                  }}</div>
              </div>
              <div class="w-1/2">
        ...
        <div class="z-[10] flex flex-col justify-center items-center absolute" :style="{
      ...
      <div class="flex justify-center items-center pt-[70px]">
        <div class="w-[calc(80vw)] max-w-[1200px] text-[25px] font-[300] leading-[200%] text-justify">
          By integrating 3D exterior visualization into their workflow, these professionals <span class="font-[500]">can
            reduce
