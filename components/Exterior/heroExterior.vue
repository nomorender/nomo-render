<template>
  <div class="pb-20">
    <div class="md:pb-[80px] pb-[20px] pt-[90px] md:flex justify-center items-center w-full">
      <div class="px-10 md:px-0 md:flex items-center justify-center gap-[30px] md:w-[81vw] md:max-w-[1200px] transition-all">
        <div class="flex flex-col md:w-[50%]">
          ...
          <div class="md:mt-7 mt-5">
            <UButton class="hidden sm:block hover:bg-[#1e1e1e] hover:text-white transition-all" color="white"
              ...
              QUOTE</UButton>
            <UButton class="sm:hidden" @click="isOpen = true" color="white" variant="outline"><span class="text-[13px] font-[400]">REQUEST A QUOTE</span></UButton>
          </div>
        </div>
        <div class="">
          <p class="md:pt-0 mt-7 md:text-[25px] text-[15px] md:w-[480px] font-[300] md:leading-[200%] leading-[180%] text-justify"><span class="font-[500]">Top-notch
              quality</span>
    ...
    <NuxtImg alt="heroPic" src="Extorior/HTL01.png" class="w-full md:h-[700px] h-[266px] object-cover object-center"
      draggable="false" />
  </div>
