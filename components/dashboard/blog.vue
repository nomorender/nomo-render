...
<template>
    ...
    <ModalEditBlog v-if="isOpen" :mode="mode" v-model="isOpen" :id="openId" @saved="handleSaved" />
    <ConfirmModal v-model="confirmOpen" title="Delete blog post?" message="This action cannot be undone."
